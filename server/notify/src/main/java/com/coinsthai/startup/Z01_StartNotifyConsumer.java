...
import com.coinsthai.edm.mq.consumer.NotifyEventListenerFactory;
 ...
 */
@Component
public class Z01_StartNotifyConsumer implements StartupInitializer {

    private static final Logger LOGGER = LoggerFactory.getLogger(Z01_StartNotifyConsumer.class);

    @Autowired
    private AliyunOnsConsumerConfig config;

    @Autowired
    private NotifyEventListenerFactory listener;
    ...
    public void initialize() {
        ...
        if (LOGGER.isInfoEnabled()) {
            ...
            LOGGER.info("Notify consumer started.");
        }
    }
}
